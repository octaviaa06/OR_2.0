...
<aside id="sidebar" class="sidebar expanded">
    ...
    <ul class="nav flex-column px-2">
            ...
            <a href="{{ route('guru.dashboard') }}" class="nav-link {{ request()->routeIs('guru.dashboard') ? 'active' : '' }}">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="none">
                        <rect x="3" y="3" width="7" height="7" rx="1" fill="url(#g-dash-primary)" opacity="0.3"/>
                        <rect x="14" y="3" width="7" height="7" rx="1" stroke="currentColor" stroke-width="2"/>
                        <rect x="3" y="14" width="7" height="7" rx="1" stroke="currentColor" stroke-width="2"/>
                        <rect x="14" y="14" width="7" height="7" rx="1" stroke="currentColor" stroke-width="2"/>
                        <defs>
                            <linearGradient id="g-dash-primary" x1="0" y1="0" x2="24" y2="24">
            ...
            <a href="{{ route('guru.siswa.index') }}" class="nav-link {{ request()->routeIs('guru.siswa.*') ? 'active' : '' }}">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M6 12v5c3 3 9 3 12 0v-5" fill="url(#g-siswa-primary)" opacity="0.2" stroke="currentColor" stroke-width="2"/>
                        <defs>
                            <linearGradient id="g-siswa-primary" x1="2" y1="5" x2="22" y2="17">
        ...
        <li class="nav-item">
            <a href="{{ route('guru.izin.index') }}" class="nav-link {{ request()->routeIs('guru.izin.*') ? 'active' : '' }}">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="none">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" fill="url(#g-izin-primary)" opacity="0.2" stroke="currentColor" stroke-width="2"/>
        ...
        <li class="nav-item">
            <a href="#" class="nav-link">
                <span class="nav-icon hover-shake">
                    <svg viewBox="0 0 24 24" fill="none">
                        <rect x="3" y="4" width="18" height="18" rx="2" fill="url(#g-kalender-primary)" opacity="0.25" stroke="currentColor" stroke-width="2"/>
                        <line x1="16" y1="2" x2="16" y2="6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                        <line x1="8" y1="2" x2="8" y2="6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                        <line x1="3" y1="10" x2="21" y2="10" stroke="currentColor" stroke-width="2"/>
                        <defs>
                            <linearGradient id="g-kalender-primary" x1="3" y1="4" x2="21" y2="22">
                                <stop offset="0%" stop-color="#6366F1"/>
                                <stop offset="100%" stop-color="#818CF8"/>
                            </linearGradient>
                        </defs>
    ...
    <div class="sidebar-filler">
        <svg class="filler-illustration" viewBox="0 0 200 120" fill="none" aria-hidden="true">
            ...
            <defs>
                <linearGradient id="g-rocket-body" x1="15" y1="0" x2="45" y2="75">
    ...
    <div class="sidebar-footer">
        <div class="user-mini">
            ...
            <div class="user-info">
                <span class="user-name">{{ session('username') ?? 'Guru' }}</span>
