    ...
    <ul class="nav flex-column px-2">
        ...
        <li class="nav-item">
            <a href="{{ route('admin.guru.index') }}" class="nav-link {{ request()->routeIs('admin.guru.*') ? 'active' : '' }}">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="none">
                        <circle cx="9" cy="7" r="4" fill="url(#guru-primary)" opacity="0.25"/>
                        ...
                        <defs>
                            <linearGradient id="guru-primary" x1="5" y1="3" x2="13" y2="11">
                                <stop offset="0%" stop-color="#8B5CF6"/>
        ...
        {{-- Perizinan --}}
        <li class="nav-item">
            <a href="{{ route('admin.perizinan.index') }}" class="nav-link {{ request()->routeIs('admin.perizinan.*') ? 'active' : '' }}">
                <span class="nav-icon">
                    <svg viewBox="0 0 24 24" fill="none">
        ...
        {{-- Kalender --}}
        <li class="nav-item">
            <a href="{{ route('admin.kalender.index') }}" class="nav-link {{ request()->routeIs('admin.kalender.*') ? 'active' : '' }}">
                <span class="nav-icon hover-shake">
                    <svg viewBox="0 0 24 24" fill="none">
                        <rect x="3" y="4" width="18" height="18" rx="2" fill="url(#kalender-primary)" opacity="0.25" stroke="currentColor" stroke-width="2"/>
                        <line x1="16" y1="2" x2="16" y2="6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                        <line x1="8" y1="2" x2="8" y2="6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
                        <line x1="3" y1="10" x2="21" y2="10" stroke="currentColor" stroke-width="2"/>
                        <defs>
                            <linearGradient id="kalender-primary" x1="3" y1="4" x2="21" y2="22">
                                <stop offset="0%" stop-color="#6366F1"/>
                                <stop offset="100%" stop-color="#818CF8"/>
                            </linearGradient>
                        </defs>
