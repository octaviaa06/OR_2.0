...
<div class="d-flex">
    ...
    <div class="flex-grow-1 main-content absensi-bg">
        <div class="container-fluid">
            ...
            {{-- Filter Form --}}
            <form id="filterForm" method="GET" action="{{ route('admin.absensi.index') }}">
...
<script>
    window.absensiConfig = {!! json_encode([
        'simpanUrl' => route('admin.absensi.simpan'),
        'exportUrl' => route('admin.absensi.export'),
        'csrf' => csrf_token(),
        'kelasGuru' => $kelasGuru,
